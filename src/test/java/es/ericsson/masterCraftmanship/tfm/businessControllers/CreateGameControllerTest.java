...
public class CreateGameControllerTest {
	...
	public void setup() {
		...
		Mockito.when(sessionDaoService.createGameSession(new Player("UserNonExistTest", "userNonExistTest")))
				.thenReturn(false);
		Mockito.when(playerDaoService.findPlayerByUsername("UserExistTest"))
				.thenReturn(new Player("UserExistTest", "userExistTest"));
		Mockito.when(sessionDaoService.createGameSession(new Player("UserExistTest", "userExistTest")))
				.thenReturn(false);
	}
